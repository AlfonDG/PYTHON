...
nombrePersona = str(input("Introduzca el nombre de la persona: "))

for clave,valor in censoImperio.items():

    if valor == nombrePersona:
        print("Hemos encontrado el nombre de la persona: ")